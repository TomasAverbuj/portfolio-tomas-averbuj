...
export const projects = [
  ...
  },
  {
    ...
    category: "Sitio institucional + WooCommerce",
    year: "2026",
    role: "Diseño y desarrollo",
    location: "Vega Baja, Puerto Rico",
    featured: true,
    shortDescription:
      "Sitio de belleza y bienestar con WooCommerce para servicios: facial, corporal, láser, micropigmentación y cabello.",
    longDescription: [
      "Proyecto desarrollado para ",
      JRA,
      ". ",
      { href: "https://yrbrowsbeauty.com/", label: "YR' Brows & Beauty Studio" },
      " es el espacio de Yaileen Ríos en Vega Baja: estética facial y corporal, depilación láser, micropigmentación y servicios de cabello. Diseñé y desarrollé una web cálida y ordenada — hero, propósito, servicios y contacto/WhatsApp — con ",
      "WooCommerce integrado para catalogar y gestionar los servicios",
      ", tipografía expresiva y foco en la experiencia mobile, para que una clienta entienda la oferta y reserve sin fricción.",
    ],
    technologies: ["WordPress", "WooCommerce", "HTML + CSS", "JavaScript", "UX/UI"],
    ...deviceSet("yr-brows"),
    link: "https://yrbrowsbeauty.com/",
    en: {
      category: "Institutional site + WooCommerce",
      role: "Design & development",
      shortDescription:
        "Beauty and wellness site with WooCommerce for services: facial, body, laser, micropigmentation and hair.",
      longDescription: [
        "Project built for ",
        JRA,
        ". ",
        { href: "https://yrbrowsbeauty.com/", label: "YR' Brows & Beauty Studio" },
        " is Yaileen Ríos’s studio in Vega Baja: facial and body aesthetics, laser hair removal, micropigmentation and hair services. I designed and built a warm, ordered site — hero, purpose, services and WhatsApp/contact — with ",
        "WooCommerce integrated to catalog and manage services",
        ", expressive type and a mobile-first experience so clients grasp the offer and book without friction.",
      ],
    },
  },
  {
