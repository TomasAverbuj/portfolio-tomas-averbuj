...
const services = [
  {
    n: "01",
    title: "WordPress",
    text: "Sitios institucionales, tiendas WooCommerce y sistemas a medida. El núcleo de casi todo lo que lanzo: editable, sólido y listo para el cliente.",
  },
  {
    n: "02",
    title: "UI / UX",
  ...
  },
  {
    n: "03",
    title: "E-commerce",
    text: "Tiendas WooCommerce y flujos de compra que no se traban: catálogo, checkout y operación real del negocio.",
  },
  {
    n: "04",
    title: "Google Ads",
    text: "Campañas de búsqueda y performance: tráfico calificado, medición y ajustes con criterio.",
  },
  {
    n: "05",
...
const stats = [
  { value: "03+", label: "Años construyendo" },
  { value: "10+", label: "Proyectos lanzados" },
  { value: "PR · AR", label: "Mercados" },
    ...
    <main className="bg-ink text-paper">
      <section className="relative min-h-screen flex flex-col justify-end overflow-hidden pt-28 pb-16">
        ...
        <div className="site-pad relative z-10 w-full">
          ...
          <div className="grid lg:grid-cols-12 gap-10 lg:gap-8 items-center">
            <div className="lg:col-span-7">
              <SplitLines
                ...
                delay={introDelay}
                lines={["Diseño y desarrollo", "de experiencias web", "que se sienten actuales."]}
              />
            </div>
            <motion.div
          ...
          <div className="mt-10 md:mt-14 grid md:grid-cols-12 gap-8 items-end">
            ...
            >
              Ayudo a marcas y negocios a lanzar y verse a la altura — con WordPress, diseño y desarrollo a medida.
              Co-fundador de NekoDev. Colaboro con JRA Web Design y tomo proyectos propios.
            </motion.p>
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
      ...
      <section id="work" className="pt-24 md:pt-32 pb-8">
        <div className="site-pad mb-12 md:mb-16 flex flex-col md:flex-row md:items-end justify-between gap-6">
          <div>
            <p className="eyebrow mb-4">Trabajos seleccionados</p>
            <ScrollSplit
              className="section-title"
              lines={["Proyectos que", "lanzan y venden."]}
            />
          </div>
          <Reveal delay={0.15}>
            <p className="text-paper/55 max-w-sm md:text-right">
              Estudio, e-commerce e institucional — más el archivo de trabajo.
            </p>
          </Reveal>
        </div>
        ...
        <div className="site-pad mt-16 md:mt-24">
          <div className="flex items-end justify-between mb-8">
            ...
            <Link to="/projects" className="font-syne text-[11px] tracking-[0.2em] uppercase text-paper/70 hover:text-paper">
              Ver archivo ({projects.length})
            </Link>
          </div>
      ...
      <section className="py-24 md:py-32">
        <div className="site-pad max-w-4xl">
          <p className="eyebrow mb-5">Quién soy</p>
          <ScrollSplit
            className="font-display text-4xl md:text-6xl leading-[0.95]"
            lines={["Un estudio chico.", "El trabajo, no."]}
          />
          <Reveal delay={0.1}>
            <p className="mt-8 text-lg text-paper/65 max-w-xl leading-relaxed">
              Soy Tomás, co-fundador de{" "}
              <a
              ...
              junto a Luna Bianchi. Diseño y desarrollo sitios en WordPress — de la arquitectura al launch — y también
              campañas de Google Ads y e-mail marketing con Brevo.
            </p>
          </Reveal>
          <Reveal delay={0.16}>
            <p className="mt-4 text-lg text-paper/65 max-w-xl leading-relaxed">
              ...
              , sin relación de dependencia: trabajo con ellos y sigo tomando proyectos propios.
            </p>
          </Reveal>
          <Reveal delay={0.18}>
      ...
      <section className="bg-paper text-ink py-24 md:py-32">
        <div className="site-pad">
          <p className="eyebrow !text-ink/45 mb-4">Servicios</p>
          <ScrollSplit
            className="font-display text-4xl md:text-6xl lg:text-7xl leading-[0.95] text-ink"
            lines={["Todo lo que", "un launch necesita."]}
          />
        ...
        <div className="site-pad grid lg:grid-cols-12 gap-12">
          <div className="lg:col-span-5">
            ...
            <p className="mt-6 text-paper/60 max-w-sm">
              Un mail alcanza. Si hay fit, armamos alcance, tiempos y arrancamos.
            </p>
          </div>
          <div className="lg:col-span-7">
            <ContactForm />
